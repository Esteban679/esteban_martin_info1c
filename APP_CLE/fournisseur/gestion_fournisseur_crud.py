...
from APP_CLE.fournisseur.gestion_genres_wtf_forms import FormWTFAjouterGenres
from APP_CLE.fournisseur.gestion_genres_wtf_forms import FormWTFDeleteGenre
from APP_CLE.fournisseur.gestion_genres_wtf_forms import FormWTFUpdateGenre
...
@obj_mon_application.route("/genres_afficher/<string:order_by>/<int:id_fournisseur_sel>", methods=['GET', 'POST'])
def genres_afficher(order_by, id_fournisseur_sel):
    ...
    return render_template("fournisseur/genres_afficher.html", data=data_fournisseur)
...
def genres_ajouter_wtf():
    ...
    if request.method == "POST":
        try:
            ...
            if form.validate_on_submit():
                ...
                name_nom_fournisseur = name_nom_fournisseur_wtf.lower()
    ...
    return render_template("fournisseur/genres_ajouter_wtf.html", form=form)
...
def genre_update_wtf():
    ...
    return render_template("fournisseur/genre_update_wtf.html", form_update=form_update)
...
def genre_delete_wtf():
    ...
    return render_template("fournisseur/genre_delete_wtf.html",
